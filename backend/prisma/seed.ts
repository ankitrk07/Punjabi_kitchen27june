...
const DISHES = [
  ...
  // ==================== PAGE 2 ====================
  // MAIN_COURSE -> Veg
  { id: "Veg_Navratan_Korma", name: "Veg Navratan Korma", price: 260, description: "Mild, sweet, and rich gravy with 9 gems of vegetables and nuts.", image: "/uploads/20260630_235546.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.6 },
  { id: "Veg_Jhalfrezi", name: "Veg Jhalfrezi", price: 240, description: "Tangy and spicy stir-fried vegetables with onions and bell peppers.", image: "/uploads/20260630_235633.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.5 },
  { id: "Veg-do-pyaza", name: "Veg Do Pyaza", price: 230, description: "Seasonal vegetables cooked in spicy onion-based gravy.", image: "/uploads/20260630_235649.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.4 },
  { id: "Veg_Kadahi", name: "Veg Kadahi", price: 250, description: "Veggies cooked in wok with fresh kadai spices.", image: "/uploads/20260630_235705.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.6 },
  { id: "Veg_Jaipuri", name: "Veg Jaipuri", price: 260, description: "Jaipuri-style mixed veg curry topped with papad.", image: "/uploads/20260630_235741.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.5 },
  { id: "Veg_Hydrabadi", name: "Veg Hyderabadi", price: 250, description: "Mixed veggies cooked in rich green spinach-mint-coriander gravy.", image: "/uploads/20260630_235800.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.6 },
  { id: "Veg_Handi", name: "Veg Handi", price: 255, description: "Creamy mixed vegetables slow-cooked in a clay handi.", image: "/uploads/20260630_235819.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.5 },
  { id: "Veg_Dahi_Wala", name: "Veg Dahi Wala", price: 240, description: "Vegetables simmered in rich yogurt-based mild gravy.", image: "/uploads/20260630_235834.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.4 },
  { id: "Veg_Tawa", name: "Veg Tawa", price: 250, description: "Dry, spicy vegetables sizzled on a iron griddle (tawa).", image: "/uploads/20260630_235857.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.5 },
  { id: "Veg_Lababdar", name: "Veg Lababdar", price: 260, description: "Mixed veg cooked in thick creamy tomato gravy with cheese.", image: "/uploads/20260630_235913.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.7 },
  { id: "Mix_Vegetable", name: "Mix Vegetable", price: 210, description: "Assorted vegetables cooked in a simple onion-tomato base.", image: "/uploads/20260630_235932.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.5 },
  { id: "Panner_Butter_Masala", name: "Paneer Butter Masala", price: 290, description: "Paneer chunks in a creamy, butter-enriched tomato sauce.", image: "/uploads/20260630_235952.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.9 },
  { id: "Paneer_Korma", name: "Paneer Korma", price: 280, description: "Cottage cheese in white cashew nut gravy.", image: "/uploads/20260701_000008.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.7 },
  { id: "Paneer_Keema", name: "Paneer Keema", price: 270, description: "Scrambled paneer with onions, tomatoes, and spices.", image: "/uploads/20260701_000029.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.8 },
  { id: "Paneer_Tikka_Butter_Masala", name: "Paneer Tikka Butter Masala", price: 310, description: "Grilled paneer tikka skewered and cooked in masala gravy.", image: "/uploads/20260701_000047.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.9 },
  { id: "Paneer_Kadahi", name: "Kadai Paneer", price: 270, description: "Spicy paneer sautéed with bell peppers in a wok.", image: "/uploads/20260701_000113.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.8 },
  { id: "Paneer_Handi", name: "Paneer Handi", price: 280, description: "Paneer cooked in a clay pot with creamy gravy.", image: "/uploads/20260701_000156.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.7 },
  { id: "Paneer_Hydrabadi", name: "Paneer Hyderabadi", price: 280, description: "Paneer cooked in rich spinach-mint Hyderabadi gravy.", image: "/uploads/20260701_000212.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.7 },
  { id: "Paneer_Maharaja", name: "Paneer Maharaja", price: 320, description: "Chef's special double-layered royal paneer gravy.", image: "/uploads/20260701_000230.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.9 },
  { id: "Panner_Makhan_Wala", name: "Paneer Makhan Wala", price: 290, description: "Paneer pieces loaded in rich, buttery, velvety tomato sauce.", image: "/uploads/20260701_000301.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.8 },
  { id: "Panner_Dahi_Wala", name: "Paneer Dahi Wala", price: 275, description: "Cottage cheese cooked in a smooth curd base.", image: "/uploads/20260701_000330.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.6 },
  { id: "Paneer_Kholapuri", name: "Paneer Kolhapuri", price: 285, description: "Fiery spicy paneer dish with Kolhapuri ground spices.", image: "/uploads/20260701_000423.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.8 },
  { id: "Paneer_Corn_Palak_Masala", name: "Paneer Corn Palak Masala", price: 290, description: "Paneer and sweet corn cooked in spiced spinach puree.", image: "/uploads/20260701_000447.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.7 },
  { id: "Panner_Mushroom_Taj_(Special)", name: "Paneer Mushroom Taj (Special)", price: 340, description: "House special combining grilled paneer and button mushrooms in a majestic gravy.", image: "/uploads/20260701_000508.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.9 },
  { id: "Shahi_Paneer", name: "Shahi Paneer", price: 280, description: "Royal paneer dish in sweet creamy onion-cashew sauce.", image: "/uploads/20260701_000529.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.8 },
  { id: "Matar_Paneer", name: "Matar Paneer", price: 260, description: "Classic combination of paneer and fresh green peas in gravy.", image: "/uploads/20260701_000549.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.7 },
  { id: "Paneer_Kofta", name: "Paneer Kofta", price: 270, description: "Cottage cheese balls served in thick spiced curry.", image: "/uploads/20260701_000611.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.6 },
  { id: "Matki_Paneer", name: "Matki Paneer", price: 290, description: "Paneer cooked inside clay pot with special Punjabi herbs.", image: "/uploads/20260701_000630.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.7 },
  { id: "Kaju_Curry", name: "Kaju Curry", price: 300, description: "Roasted cashew nuts cooked in rich creamy onion-tomato gravy.", image: "/uploads/20260701_000655.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.8 },
  { id: "Palak_Corn", name: "Palak Corn", price: 240, description: "Sweet corn kernels inside seasoned spinach cream.", image: "/uploads/20260701_000728.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.6 },
  { id: "Mushroom_Matar_Masala", name: "Mushroom Matar Masala", price: 260, description: "Fresh button mushrooms and green peas in red masala gravy.", image: "/uploads/20260701_000745.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.6 },
  { id: "Mushroom_Butter_Masala", name: "Mushroom Butter Masala", price: 270, description: "Mushrooms in rich tomato butter gravy.", image: "/uploads/20260701_000809.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.7 },
  { id: "Mushroom_Do_Pyaza", name: "Mushroom Do Pyaza", price: 265, description: "Button mushrooms sautéed with lots of onions.", image: "/uploads/20260701_000838.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.6 },
  { id: "Mushroom_Tawa", name: "Mushroom Tawa", price: 270, description: "Spicy mushroom cooked dry on tawa griddle.", image: "/uploads/20260701_000855.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.5 },
  { id: "Mushroom_Palak", name: "Mushroom Palak", price: 250, description: "Mushrooms cooked in healthy spiced spinach gravy.", image: "/uploads/20260701_001002.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.5 },
  { id: "Veg_Kofta", name: "Veg Kofta", price: 220, description: "Deep-fried mixed vegetable balls in gravy.", image: "/uploads/20260701_001017.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.5 },
  { id: "Malai_Kofta", name: "Malai Kofta", price: 260, description: "Potato paneer dumplings in sweet cashew cream gravy.", image: "/uploads/20260701_001039.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.8 },
  { id: "Baby_Corn_Masala", name: "Baby Corn Masala", price: 240, description: "Crisp baby corn cuts in spiced onion-tomato curry.", image: "/uploads/20260701_001100.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.5 },
  { id: "Corn_Masala", name: "Corn Masala", price: 230, description: "Sweet corn kernels cooked in warm Indian gravy.", image: "/uploads/20260701_001114.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.4 },
  { id: "Green_Peace_Masala", name: "Green Peas Masala", price: 220, description: "Fresh green peas in spiced onion-tomato gravy.", image: "/uploads/20260701_001131.jpeg", veg: true, categoryId: "main_course_veg", rating: 4.5 },

  // MAIN_COURSE -> Non-Veg
  { id: "Chicken_Curry_(2_Pcs)", name: "Chicken Curry (2 Pcs)", price: 180, description: "Home-style traditional chicken curry cooked in thin gravy.", image: "/uploads/20260701_001145.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.7 },
  { id: "Chicken_Masala_(2_Pcs)", name: "Chicken Masala (2 Pcs)", price: 200, description: "Spicy chicken pieces in a thick masala paste.", image: "/uploads/20260701_001202.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.7 },
  { id: "Chicken_Butter_Masala_(2_Pcs)", name: "Chicken Butter Masala (2 Pcs)", price: 220, description: "Tender chicken pieces cooked in butter-tomato-cashew gravy.", image: "/uploads/20260701_001239.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.8 },
  { id: "Chicken_Korma_(2_Pcs)", name: "Chicken Korma (2 Pcs)", price: 210, description: "Chicken slow cooked in royal cashew-yogurt sauce.", image: "/uploads/20260701_001308.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.6 },
  { id: "Chicken_Do_Pyaza_(2_Pcs)", name: "Chicken Do Pyaza (2 Pcs)", price: 210, description: "Chicken cooked with double amount of crunchy onions.", image: "/uploads/20260701_001325.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.6 },
  { id: "Chicken_Bharta", name: "Chicken Bharta", price: 260, description: "Shredded chicken cooked in egg, butter, and cashew onion paste.", image: "/uploads/1.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.8 },
  { id: "Chicken_Handi_(4_Pcs)", name: "Chicken Handi (4 Pcs)", price: 340, description: "Creamy chicken curry cooked in traditional clay pot.", image: "/uploads/2.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.8 },
  { id: "Chicken_Kadahi_(4_Pcs)", name: "Chicken Kadai (4 Pcs)", price: 340, description: "Wok-cooked chicken with chunky onions, tomatoes, and bell peppers.", image: "/uploads/3.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.7 },
  { id: "Chicken_Peshawari_(4_Pcs)", name: "Chicken Peshawari (4 Pcs)", price: 360, description: "Rich, mildly spiced chicken dish from Peshawar region.", image: "/uploads/4.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.8 },
  { id: "Chicken_Kolhapuri_(4_Pcs)", name: "Chicken Kolhapuri (4 Pcs)", price: 350, description: "Extremely spicy chicken dish with dry coconut and chillies.", image: "/uploads/5.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.7 },
  { id: "Chicken_Methi_Malai_(4_Pcs)", name: "Chicken Methi Malai (4 Pcs)", price: 370, description: "Rich white chicken gravy flavored with fresh fenugreek leaves (methi) and cream.", image: "/uploads/6.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.8 },
  { id: "Chicken_Saagwala_(4_Pcs)", name: "Chicken Saagwala (4 Pcs)", price: 340, description: "Chicken cooked in a green dynamic spinach puree.", image: "/uploads/7.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.6 },
  { id: "Chicken_Lucknawi_(4_Pcs)", name: "Chicken Lucknawi (4 Pcs)", price: 380, description: "Delicately flavored white chicken curry Lucknow-style.", image: "/uploads/8.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.8 },
  { id: "Makhani_Chicken_(4_Pcs)", name: "Makhani Chicken (4 Pcs)", price: 350, description: "Shredded and grilled tandoori chicken cooked in rich buttery sauce.", image: "/uploads/9.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.9 },
  { id: "Tawa_Chicken_(4_Pcs)", name: "Tawa Chicken (4 Pcs)", price: 360, description: "Spiced chicken stir-fried on large iron griddle.", image: "/uploads/10.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.8 },
  { id: "Chicken_Tikka_Butter_Masala_(8_Pcs)", name: "Chicken Tikka Butter Masala (8 Pcs)", price: 480, description: "Skewered chicken tikka cooked in hot spiced butter gravy.", image: "/uploads/11.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.9 },
  { id: "Chicken_Kassa_(8_Pcs)", name: "Chicken Kassa (8 Pcs)", price: 440, description: "Bengali style slow-cooked dry spicy chicken.", image: "/uploads/12.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.7 },
  { id: "Chicken_Lababdar_(8_Pcs)", name: "Chicken Lababdar (8 Pcs)", price: 460, description: "Creamy sweet and tangy chicken gravy with cheese.", image: "/uploads/13.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.8 },
  { id: "Chicken_Patiyala_(8_Pcs)", name: "Chicken Patiala (8 Pcs)", price: 490, description: "Punjabi special chicken wrapped inside egg omelette served in yellow gravy.", image: "/uploads/14.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.9 },
  { id: "Chicken_Dehati_Full_(8_Pcs)", name: "Chicken Dehati Full (8 Pcs)", price: 520, description: "Rustic country-style chicken curry with whole garlic bulbs.", image: "/uploads/15.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.8 },
  { id: "Punjabi_Kitchen_Special_(8_Pcs)", name: "Punjabi Kitchen Special (8 Pcs)", price: 580, description: "Chef's signature chicken curry using rare herbs and spices.", image: "/uploads/16.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 5.0 },
  { id: "Chicken_Maharaja_Full(8_Pcs)", name: "Chicken Maharaja Full (8 Pcs)", price: 560, description: "Royal style chicken cooked in two layers of gravies with boiled eggs.", image: "/uploads/17.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.9 },
  { id: "Matka_Chicken_Full(8_Pcs)", name: "Matka Chicken Full (8 Pcs)", price: 570, description: "Juicy chicken cooked inside clay pot with special spices.", image: "/uploads/18.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.9 },
  { id: "Murg_Musalam_Full_(8_Pcs)", name: "Murg Musallam Full (8 Pcs)", price: 590, description: "Whole roasted tandoori chicken stuffed with eggs and minced mutton in thick gravy.", image: "/uploads/19.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 5.0 },
  { id: "Mutton_Curry_(4_Pcs)", name: "Mutton Curry (4 Pcs)", price: 400, description: "Home-style tender goat mutton curry cooked in spicy broth.", image: "/uploads/20.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.8 },
  { id: "Mutton_Masala_(4_Pcs)", name: "Mutton Masala (4 Pcs)", price: 420, description: "Slow-cooked mutton pieces in a thick, semi-dry spice masala.", image: "/uploads/21.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.8 },
  { id: "Mutton_Rogan_Josh_(4_Pcs)", name: "Mutton Rogan Josh (4 Pcs)", price: 420, description: "Kashmiri style aromatic goat mutton cooked with alkanet root.", image: "/uploads/22.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.9 },
  { id: "Fish_Curry_(2_Pcs)", name: "Fish Curry (2 Pcs)", price: 280, description: "Fresh fish cooked in mustard-onion curry.", image: "/uploads/23.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.6 },
  { id: "Fish_Masala_(2_Pcs)", name: "Fish Masala (2 Pcs)", price: 300, description: "Pan fried fish coated in hot masala sauce.", image: "/uploads/24.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.7 },
  { id: "Fish_Do_Pyaza_(2_Pcs)", name: "Fish Do Pyaza (2 Pcs)", price: 300, description: "Fish pieces cooked with caramelized onion gravy.", image: "/uploads/25.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.6 },
  { id: "Fish_Fry_(2_Pcs)", name: "Fish Fry (2 Pcs)", price: 260, description: "Crispy batter-fried fish fillets seasoned with chaat masala.", image: "/uploads/26.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.7 },
  { id: "Egg_Curry_(2_Pcs)", name: "Egg Curry (2 Pcs)", price: 180, description: "Boiled and pan-fried eggs served in spicy curry.", image: "/uploads/27.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.5 },
  { id: "Egg_Masala_(2_Pcs)", name: "Egg Masala (2 Pcs)", price: 200, description: "Eggs cooked inside heavily spiced thick dry masala gravy.", image: "/uploads/28.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.6 },
  { id: "Egg_Do_Pyaza_(2_Pcs)", name: "Egg Do Pyaza (2 Pcs)", price: 200, description: "Boiled eggs cooked in onion-rich sauce.", image: "/uploads/29.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.5 },
  { id: "Omellete_Masala_(2_Pcs)", name: "Omelette Masala (2 Pcs)", price: 120, description: "Spiced double-egg omelette cooked with onions and chillies.", image: "/uploads/30.jpeg", veg: false, categoryId: "main_course_non_veg", rating: 4.5 },
